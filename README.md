...
* [`src/cljs/todo/`](src/cljs/todo/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/todo/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/todo/`](test/cljs/todo/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `todo` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/todo/config.cljs) defaults to `true` in
